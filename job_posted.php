    ...
    <!-- Begin Paper -->
      ...
      <div id="paper-mid">
		...
		while($row = $result->fetch_assoc()) {
			...
			<div style="display:none"><input type="number" value="<?php echo $J_id; ?>" name="J_id_selected"></div>
			<td><button type="submit">View</button></td>
			</form>
			<form action="application_ops.php" method="post">
			<div style="display:none"><input type="number" value="<?php echo $J_id; ?>" name="J_id_selected">
			<input type="text" value="edit_job" name="action">
			</div>
			<td><button type="submit">Edit</button></td>
			</form>
			<form action="application_ops.php" method="post">
			<div style="display:none"><input type="number" value="<?php echo $J_id; ?>" name="J_id_selected">
			<input type="text" value="jobs_del" name="action">
			</div>
