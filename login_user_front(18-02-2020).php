				    ...
				    <div class="container-fluid">
				        ...
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
				                <li class="active"><a href="http://localhost/jobbee_home.php">Home</a></li>
				                ...
				                <li><a href="http://localhost/jobbee_jobs.php">Jobs</a></li>
								<li><a href="jobbee_contact.html">Contact</a></li>
				                <!--<li><a href="case-studies.html">Case Studies</a></li>
...
<div class="self1">
		...
		<div class="self2">
            ...
            <ul class="ver_nav">
              ...
              <li class="login_opt"><a href="http://localhost/job_suggestion_website/resume_format.php">Resume</a></li>
    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        <!--<div class="entry">
          ...
          <!--<div class="self">
            <h1 class="name">John Smith </h1><br />
              <!--<span>Interactive Designer</span></h1>-->
            <!--<ul>
        ...
        <!--</div>
        <!-- Begin 1st Row -->
        <div class="right-sec entry ">
          <h3>OBJECTIVE</h3>
		  <div class="content">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
		  Proin dignissim viverra nibh sed varius. Proin bibendum nunc in sem ultrices posuere. 
		  Aliquam ut aliquam lacus.
		  ufvniuehnfconkdnddfokefkfj</p>
		  </div>
        </div>
        <!-- End 1st Row -->
        <!-- Begin 2nd Row -->
        <div class="entry right-sec">
          <h3>EDUCATION</h3>
          <div class="content">
            <h4>Sep 2005 - Feb 2007</h4>
            <p>Marticulation, London <br />
			   <em>xxx Board</em> 
              <em>xxx %</em></p>
          </div>
          <div class="content">
            <h4>Sep 2001 - Jun 2005</h4>
            <p>Intermediate, New York <br />
			  <em>xxx Board</em> 
              <em>xxx %</em></p>
          </div>
        </div>
