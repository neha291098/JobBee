...
<div class="self1">
		...
		<div class="self2">
            ...
            <ul class="ver_nav">
              ...
              <li class="login_opt"><a  class="active_ver" href="http://localhost/job_suggestion_website/add_job.php" >Add Job</a></li>
...
<section>
	...
	<div class="right-sec-main">
				<form action="add_job_action.php" method="post" role="form" class="contactform " name="myForm" onsubmit="return validateForm();">
				<!--<div class="next_box" >-->
				<fieldset>
	<legend class="lead"><center><b>Description</b></center></legend>
		<div class="form-group">
      <label for="twelth_pyear">Location</label>
      <input type="text" class="form-control" id="twelth_pyear" placeholder="Enter Location" name="Location"  required>
    </div>
	    <div class="form-group">
      <label for="twelth_per">Profile</label>
      <input type="text" class="form-control" id="twelth_per" placeholder="Enter Profile" name="Profile" required>
    </div>
	    <div class="form-group">
      <label for="twelth_school">Company</label>
      <input type="text" class="form-control" id="twelth_school" placeholder="Enter Company" name="Company" required>
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Job Description</label>
      <textarea rows="" class="form-control" id="Job_desc" placeholder="Enter Description" name="Job_desc" required></textarea>
    </div>
	</fieldset>
	...
	<legend class="lead"><center><b>Details</b></center></legend>
      ...
      <input type="text" class="form-control" id="twelth_pyear" placeholder="Enter Headquarter" name="Headquarter" required>
    </div>
	    <div class="form-group">
      <label for="twelth_per">Founded</label>
      <input type="number" class="form-control" id="twelth_per" placeholder="Enter Founded year" name="Founded">
    </div>
	    <div class="form-group">
      <label for="twelth_school">Size</label>
      <input type="text" class="form-control" id="twelth_school" placeholder="Enter Size" name="Size">
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Website Link</label>
      <input type="text" class="form-control" id="twelth_Board" placeholder="Enter Link" name="Website_link">
    </div>
	</fieldset>
	

	
	<button type="submit"  class="btn btn-primary" id="login_btn_user" >Add Job</button>	
	</form>	
	</div>
  </section>
