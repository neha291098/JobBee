...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li  class="active"><a class="active" href="http://localhost/job_suggestion_website/company_table.php">Companies</a></li>
...
<td> <?php echo $rows['C_Company']; ?></td>
<td> <?php echo $rows['C_JobTitle']; ?></td>
<td> <?php echo $rows['C_Email']; ?></td>
<!-- <td> <?php echo $rows['C_Setpwd']; ?></td> -->
<form action="http://localhost/job_suggestion_website/add_review.php" method="post">
<input type="hidden" value="<?php echo $rows['C_id']; ?>" name="C_id">
<input type="hidden" value="<?php echo $rows['C_Company']; ?>" name="C_Company">

<td>  <button>Add/Edit</button>     </td>
</form>

<form action="delby_admin.php" method="post">
<input type="hidden" value="delcompany" name="action">
<input type="hidden" value="<?php echo $rows['C_id']; ?>" name="C_id">
