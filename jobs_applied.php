...
<div class="self2">
            ...
            <ul class="ver_nav">
              ...
              <li class="login_opt"><a class="active_ver"href="http://localhost/job_suggestion_website/jobs_applied.php">Applications</a></li>
...
$U_id=$_SESSION['U_id'];
$sql= "select * from jobs_applied where U_id='$U_id'";
