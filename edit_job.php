...
<section>
	...
	<div class="right-sec-main">
				<form action="edit_job_action.php" name="myForm" onsubmit="return validateForm();" method="post" role="form" class="contactform ">
				<!--<div class="next_box" >-->
				<fieldset>
	<legend class="lead"><center><b>Edit Job Details</b></center></legend>
		<div class="form-group">
      <label for="twelth_pyear">Location</label>
      <input type="text" class="form-control" id="twelth_pyear" placeholder="Enter Location" name="Location" value="<?php echo $_SESSION['Location']; ?>" required>
    </div>
	    <div class="form-group">
      <label for="twelth_per">Profile</label>
      <input type="text" class="form-control" id="twelth_per" placeholder="Enter Profile" name="Profile" value="<?php echo $_SESSION['Profile']; ?>"required>
    </div>
	    <div class="form-group">
      <label for="twelth_school">Company</label>
      <input type="text" class="form-control" id="twelth_school" placeholder="Enter Company" name="Company" value="<?php echo $_SESSION['Company']; ?>" required>
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Job Description</label>
      <textarea rows="" class="form-control" id="Job_desc" placeholder="Enter Description" name="Job_desc" ><?php echo $_SESSION['Job_desc']; ?></textarea required>
    </div>
	</fieldset>
	
	<fieldset>
	<legend class="lead"><center><b>Details</b></center></legend>
		<div class="form-group">
      <label for="twelth_pyear">Headquarter</label>
      <input type="text" class="form-control" id="twelth_pyear" placeholder="Enter Headquarter" name="Headquarter" value="<?php echo $_SESSION['Headquarter']; ?>" required>
    </div>
	    <div class="form-group">
      <label for="twelth_per">Founded</label>
      <input type="number" class="form-control" id="twelth_per" placeholder="Enter Founded year" name="Founded" value="<?php echo $_SESSION['Founded']; ?>" >
    </div>
	    <div class="form-group">
      <label for="twelth_school">Size</label>
      <input type="text" class="form-control" id="twelth_school" placeholder="Enter Size" name="Size" value="<?php echo $_SESSION['Size']; ?>">
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Website Link</label>
      <input type="text" class="form-control" id="twelth_Board" placeholder="Enter Link" name="Website_link" value="<?php echo $_SESSION['Website_link']; ?>">
    </div>
	</fieldset>
...
function validateForm() {
	var a=document.forms["myForm"]["Founded"].value;
	if(a<1900 || a>2021){
			alert("Invalid Founded Year");
			return false;
		}
}
</script>
