...
<body>
   ...
   $msg=$_SESSION['message'];
	...
	?>
				<form action="user_login_action.php" name="myForm" onsubmit="return(validate());" method="post" role="form" class="contactform">
				<!--<div class="next_box" >-->
				<fieldset>
	...
	<fieldset>
      ...
      <input type="text" maxlength="20" onkeydown="return alphaOnly(event);" class="form-control" id="Name" placeholder="Enter Name" name="Name" required>
    </div>
	<div class="form-group">
      <label for="Address">Address</label>
      <input type="text" maxlength="500" class="form-control" id="Address" placeholder="Enter Address" name="Address">
    </div>
   ...
   $msg=$_SESSION['message'];
	...
	?>
      ...
      <input type="number" maxlength="10" class="form-control" id="ph_no" placeholder="Enter Phone Number" name="Ph_no">
	...
	<legend class="lead"><center><b>High School</b></center></legend>
      ...
      <input type="text" class="form-control" id="tenth_pyear" placeholder="Ex: Mar 2014" name="Tenth_pyear">
    </div>
	    <div class="form-group">
      <label for="tenth_per">Percentage</label>
      <input type="number" class="form-control" id="tenth_per" placeholder="Enter percentage" name="Tenth_per" onkeydown="return validate();">
    </div>
	    <div class="form-group">
      <label for="tenth_school">School</label>
      <input type="text" maxlength="50" class="form-control" id="tenth_school" placeholder="Enter School" name="Tenth_school">
    </div>
	    <div class="form-group">
      <label for="tenth_Board">Board</label>
      <input type="text" maxlength="50" onkeydown="return alphaOnly(event);" class="form-control" id="tenth_Board" placeholder="Enter Board" name="Tenth_board">
    </div>
	</fieldset>
	<fieldset>
	<legend class="lead"><center><b>Intermediate</b></center></legend>
      ...
      <input type="text" class="form-control" id="twelth_pyear" placeholder="Ex: Mar 2016" name="Twelth_pyear">
    </div>
	    <div class="form-group">
      <label for="twelth_per">Percentage</label>
      <input type="number" class="form-control" id="twelth_per" placeholder="Enter percentage" name="Twelth_per">
    </div>
	    <div class="form-group">
      <label for="twelth_school">School</label>
      <input type="text" maxlength="100" class="form-control" id="twelth_school" placeholder="Enter School" name="Twelth_school">
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Board</label>
      <input type="text"  maxlength="50" onkeydown="return alphaOnly(event);" class="form-control" id="twelth_Board" placeholder="Enter Board" name="Twelth_board">
    </div>
	</fieldset>
	...
	<legend class="lead"><center><b>Additional Information</b></center></legend>
	  ...
	  <div class="wrapper form-group">
	   <div class="form-group">
		<label for="P_dur[]">Duration</label><input type="date" class="form-control" name="P_dur[]" placeholder="Ex: Sep 2005- Oct 2005"/>
			</div>
		 <div class="form-group">
...
<!-- Template -->
	  ...
	  <div class="wrapper form-group">
	   <div class="form-group">
		<label for="E_dur[]">Duration</label><input type="date" class="form-control" name="E_dur[]" placeholder="Ex: Sep 2005- Oct 2005"/>
			</div>
		 <div class="form-group">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <p>2010 - 2020<a href="#"> Job-Bee</a> All rights reserved.</p>
                    </div>
